...
public class SentinelsImporter : EditorWindow
{
    ...
    static void OpenWindow()
    {
        ...
        Texture icon = AssetDatabase.LoadAssetAtPath<Texture>("Assets/Sentinels/Importer/resources/icons/icon.png");
    ...
    void DrawBody()
    {
        ...
        if (toolLogo == null)
            toolLogo = AssetDatabase.LoadAssetAtPath("Assets/Sentinels/Importer/resources/icons/logo.png", typeof(Texture2D)) as Texture2D;

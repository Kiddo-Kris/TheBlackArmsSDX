...
What can the SDX do?
Q: The SDX bypasses any limits it can and is packed full of stuff all in a small package
A: It takes so long to import!!! Why is it so long?!
Q: This is because of DLLs and Scripts, Unity uses them actively in the editor so it also compiles them on import
A: How is this SDK special?
Q: I actively look for ways to improve it and I have many plans, I also have features other SDKs dont have
A: Why is it called a SDX?
Q: I got the idea from what it stands for
...
A: Only if I have no choice, I already have a method to make my work Obfuscated with Unity still able to use the SDX in case I really have to
...
A: By using it you accept the risk of being banned but I minimize the risk as much as possible, its a 1 in a million chance, you also probably uploaded an avatar that violated VRChat ToS and got reported

...
public class SDKUpdater : MonoBehaviour
{
	...
	[MenuItem("Phoenix/SDK/Utilities/Check For Updates")]
	...
	static void ShowDownloadUpdatePopup(bool updateAvailable, string latestVersion, string sdkUrl, bool isSilent)
	{
		...
		{
			if(EditorUtility.DisplayDialog("VRChat SDK Updater", "An update is available (version " + latestVersion + ")", "DontUpdatePLZ!", "Cancel"))
			{

...
public partial class VRCSdkControlPanel : EditorWindow
{
    ...
    [MenuItem("Phoenix/SDK/Control Panel", false, 2)]
    static void ShowControlPanel()
    {
        ...
        window.titleContent.text = "The Black Arms";
    ...
    void OnGUI()
    {
        ...
        if (Application.isPlaying)
        {
            GUI.enabled = false;
            GUILayout.Space(20);
            EditorGUILayout.LabelField("M8 you cant edit while unity is running...", titleGuiStyle, GUILayout.Width(SdkWindowWidth));
            GUI.enabled = true;
        ...
        if (APIUser.IsLoggedInWithCredentials == false && showPanel != 3 && showPanel != 4 && showPanel != 5)
            showPanel = 0;
